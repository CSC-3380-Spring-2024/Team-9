...
class Game {
    ...
    checkCollision(player, platform) {
        return (player.hitBoxY + player.hitBoxHeight <= platform.hitBoxY && player.hitBoxY + player.hitBoxHeight + player.speed.y >= platform.hitBoxY && player.hitBoxX + player.hitBoxWidth >= platform.hitBoxX && player.hitBoxX <= platform.hitBoxX + platform.hitBoxSWidth);
    }
    checkIfAtEnd(player, castle) {
        return (player.hitBoxX < castle.hitBoxX + castle.hitBoxSWidth && player.hitBoxX + player.hitBoxWidth > castle.hitBoxX && player.hitBoxY < castle.hitBoxY + castle.hitBoxSHeight && player.hitBoxY + player.hitBoxHeight > castle.hitBoxY);
    }
    isCollected(a, b) {
    ...
    isClickedOn(mouse, startButton) {
        return (mouse.x < startButton.scaledX + startButton.scaledWidth && mouse.x + mouse.width > startButton.scaledX && mouse.y < startButton.scaledY + startButton.scaledHeight && mouse.y + mouse.height > startButton.scaledY);
    }
    isTouchDevice() {
